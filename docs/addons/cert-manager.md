...
To deploy cert-manager Add-on via [EKS Blueprints Addons](https://github.com/isbaran/terraform-aws-eks-blueprints-addons), reference the following parameters under the `module.eks_blueprints_addons`.
